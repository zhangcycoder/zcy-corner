...
export const profile: Profile = {
  displayName: '张赐永',
  role: '前端开发工程师',
  headline: '跨境金融科技与复杂 Web 业务前端实践',
  summary: '现聚焦跨境券商出入金方向前端，覆盖出入金、银行卡与绑卡合规、开户与身份认证、加密资产与期权等复杂业务，主导美股市场多个 0 到 1 模块；更早历史项目覆盖工业互联网、边缘计算控制台、低代码组态、AI 知识库与在线教育。关注复杂业务中的前端系统设计、功能交付与工程协作。',
  sourceNote: '现任经历按脱敏口径呈现，隐去雇主与内部项目名称；更早经历来源于历史简历。',
  focus: ['出入金 / 资金链路', '跨境多市场（HK / US / SG）', '0-1 模块', '前端系统设计'],
  links: [
  ...
  workExperience: [
    {
      id: 'work-2024-brokerage',
      period: '2024.05 — 2026.07',
      role: '前端工程师',
      organization: '跨境互联网券商（金融科技）',
      summary: '出入金（资金存取）方向核心前端，负责 H5 与 SPA 双端，覆盖香港、美国、新加坡多市场；业务域含出入金、银行卡与绑卡合规、开户与身份认证、跨券商资金划转、加密资产钱包与期权交易，并为多租户做差异化接入。从香港 / 新加坡出入金与银行卡的主力开发，成长为美股市场从 0 到 1 的独立担纲者。',
    },
    {
      id: 'wh-beyondsoft',
  ...
  projects: [
    {
      id: 'us-atm-portfolio',
      title: '美股出入金与资产分析',
      domain: '跨境券商 · 出入金与资产（0-1）',
      summary: '面向美股市场从 0 搭建的出入金与资产盈亏分析前端。',
      background: '业务向美股市场扩张，出入金与资产分析需要从 0 搭建；美股与港股在账户体系、金额精度、负数与合规上差异较大，不能简单复用港股实现。',
      contributions: [
        '页面从 0 初始化，独立担纲美股出入金前端，并搭建美股资产与盈亏分析页面。',
        '实现开户信息回填、资产足迹与交易历史、盈亏率展示策略与实现盈亏率显隐。',
        '处理转入股票的负数与精度、大数展示规则，并优化 ATM 与绑卡流程、银行卡排序与电汇出金提示。',
      ],
      challenges: [
        '在美股与港股的账户与合规差异下，权衡出入金能力的复用与隔离。',
        '保证金额精度、负数与大数展示在多场景下的一致性。',
      ],
      completedScope: [
        '美股出入金、美股资产与盈亏分析两个模块从 0 到 1 落地上线。',
      ],
    },
    {
      id: 'crypto-wallet',
      title: '加密资产钱包',
      domain: '跨境券商 · 加密资产（0-1）',
      summary: '从 0 初始化的加密资产钱包前端，覆盖资金充提、投资者认证与合规收费。',
      background: '业务扩展到加密资产，需要从 0 建立钱包前端能力，覆盖资金充提、投资者认证与合规收费。',
      contributions: [
        '初始化加密资产模块并主导前端建设。',
        '实现充提币流程、白名单管理与投资者引导认证。',
        '实现手续费按加密货币与法币双币种收取，以及储备兑换逻辑。',
      ],
      challenges: [
        '处理多币种与合规收费在前端的表达与校验。',
        '与客户端能力协作完成敏感资金操作的交互。',
